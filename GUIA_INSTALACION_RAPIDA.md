...
1. **Descargar plugin:**
   - URL: https://agente90.preview.emergentagent.com/api/wordpress/plugin/download
   - O desde terminal: `curl -o plugin.zip https://agente90.preview.emergentagent.com/api/wordpress/plugin/download`
