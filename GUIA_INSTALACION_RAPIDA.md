...
1. **Descargar plugin:**
   - URL: https://wpmoneyhub.preview.emergentagent.com/api/wordpress/plugin/download
   - O desde terminal: `curl -o plugin.zip https://wpmoneyhub.preview.emergentagent.com/api/wordpress/plugin/download`
