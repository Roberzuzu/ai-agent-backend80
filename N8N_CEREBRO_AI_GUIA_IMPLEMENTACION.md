...
```
https://wpmoneyhub.preview.emergentagent.com/api/agent/...
```
...
# Backend URL
BACKEND_URL=https://wpmoneyhub.preview.emergentagent.com
```
...
- **Backend:** `https://wpmoneyhub.preview.emergentagent.com`
