...
```
https://cerebro-ai-agent.preview.emergentagent.com/api/agent/...
```
...
# Backend URL
BACKEND_URL=https://cerebro-ai-agent.preview.emergentagent.com
```
...
- **Backend:** `https://cerebro-ai-agent.preview.emergentagent.com`
