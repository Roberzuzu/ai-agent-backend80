...
```
https://backend-connect-21.preview.emergentagent.com/api/agent/...
```
...
# Backend URL
BACKEND_URL=https://backend-connect-21.preview.emergentagent.com
```
...
- **Backend:** `https://backend-connect-21.preview.emergentagent.com`
