...
### 5. Ver Historial
```bash
curl "https://api-switcher.preview.emergentagent.com/api/agent/memory/mi_usuario?limit=5"
```
  ...
  "item": [
    {
      ...
      "request": {
        ...
        "header": [],
        "url": {
          "raw": "https://api-switcher.preview.emergentagent.com/api/agent/status",
          "protocol": "https",
    ...
    },
    {
      ...
      "request": {
        ...
        "url": {
          "raw": "https://api-switcher.preview.emergentagent.com/api/agent/execute",
          "protocol": "https",
          "host": ["api-switcher", "preview", "emergentagent", "com"],
    ...
    },
    {
      ...
      "request": {
        ...
        "header": [],
        "url": {
          "raw": "https://api-switcher.preview.emergentagent.com/api/agent/memory/postman_user?limit=5",
          "protocol": "https",
          "host": ["api-switcher", "preview", "emergentagent", "com"],
    ...
    },
    {
      ...
      "request": {
        ...
        "url": {
          "raw": "https://api-switcher.preview.emergentagent.com/api/agent/search-memory",
          "protocol": "https",
          "host": ["api-switcher", "preview", "emergentagent", "com"],
...
const BASE_URL = 'https://api-switcher.preview.emergentagent.com';
