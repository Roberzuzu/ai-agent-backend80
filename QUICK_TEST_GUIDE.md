...
```bash
curl -X POST https://backend-connect-21.preview.emergentagent.com/api/agent/execute \
...
### 5. Ver Historial
```bash
curl "https://backend-connect-21.preview.emergentagent.com/api/agent/memory/mi_usuario?limit=5"
```

### 6. Búsqueda Semántica
```bash
curl -X POST https://backend-connect-21.preview.emergentagent.com/api/agent/search-memory \
  -H "Content-Type: application/json" \
  -d '{
    "user_id": "mi_usuario",
    "query": "estadísticas",
  ...
  "item": [
    {
      ...
      "request": {
        ...
        "header": [],
        "url": {
          "raw": "https://backend-connect-21.preview.emergentagent.com/api/agent/status",
          "protocol": "https",
    ...
    },
    {
      ...
      "request": {
        ...
        "url": {
          "raw": "https://backend-connect-21.preview.emergentagent.com/api/agent/execute",
          "protocol": "https",
          "host": ["api-switcher", "preview", "emergentagent", "com"],
    ...
    },
    {
      ...
      "request": {
        ...
        "header": [],
        "url": {
          "raw": "https://backend-connect-21.preview.emergentagent.com/api/agent/memory/postman_user?limit=5",
          "protocol": "https",
          "host": ["api-switcher", "preview", "emergentagent", "com"],
    ...
    },
    {
      ...
      "request": {
        ...
        "url": {
          "raw": "https://backend-connect-21.preview.emergentagent.com/api/agent/search-memory",
          "protocol": "https",
          "host": ["api-switcher", "preview", "emergentagent", "com"],
...
const BASE_URL = 'https://backend-connect-21.preview.emergentagent.com';
