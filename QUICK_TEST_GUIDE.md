...
### 5. Ver Historial
```bash
curl "https://plugin-stability.preview.emergentagent.com/api/agent/memory/mi_usuario?limit=5"
```
  ...
  "item": [
    {
      ...
      "request": {
        ...
        "header": [],
        "url": {
          "raw": "https://plugin-stability.preview.emergentagent.com/api/agent/status",
          "protocol": "https",
    ...
    },
    {
      ...
      "request": {
        ...
        "url": {
          "raw": "https://plugin-stability.preview.emergentagent.com/api/agent/execute",
          "protocol": "https",
          "host": ["api-switcher", "preview", "emergentagent", "com"],
    ...
    },
    {
      ...
      "request": {
        ...
        "header": [],
        "url": {
          "raw": "https://plugin-stability.preview.emergentagent.com/api/agent/memory/postman_user?limit=5",
          "protocol": "https",
          "host": ["api-switcher", "preview", "emergentagent", "com"],
    ...
    },
    {
      ...
      "request": {
        ...
        "url": {
          "raw": "https://plugin-stability.preview.emergentagent.com/api/agent/search-memory",
          "protocol": "https",
          "host": ["api-switcher", "preview", "emergentagent", "com"],
...
const BASE_URL = 'https://plugin-stability.preview.emergentagent.com';
