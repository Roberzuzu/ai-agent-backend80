...
### Cambios en v1.1.0
- ✅ API URL actualizada a: `https://railway-port-config.preview.emergentagent.com/api`
...
```
https://railway-port-config.preview.emergentagent.com/api/wordpress/plugin/download
```
...
wget https://railway-port-config.preview.emergentagent.com/api/wordpress/plugin/download \
...
```bash
curl https://railway-port-config.preview.emergentagent.com/api/
```
...
2. Comprueba que la URL sea: `https://railway-port-config.preview.emergentagent.com/api`
