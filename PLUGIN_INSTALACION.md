...
### Cambios en v1.1.0
- ✅ API URL actualizada a: `https://api-switcher.preview.emergentagent.com/api`
...
```
https://api-switcher.preview.emergentagent.com/api/wordpress/plugin/download
```
...
wget https://api-switcher.preview.emergentagent.com/api/wordpress/plugin/download \
...
```bash
curl https://api-switcher.preview.emergentagent.com/api/
```
...
2. Comprueba que la URL sea: `https://api-switcher.preview.emergentagent.com/api`
