...
## 📍 URL BASE
```
https://wpmoneyhub.preview.emergentagent.com
```
...
**URL Completa:**
```
https://wpmoneyhub.preview.emergentagent.com/api/agent/chat
```
...
**Ejemplo con curl:**
```bash
curl -X POST https://wpmoneyhub.preview.emergentagent.com/api/agent/chat \
  -H "Content-Type: application/json" \
  -d '{
...
**URL Completa:**
```
https://wpmoneyhub.preview.emergentagent.com/api/agent/memory/{user_id}?limit=10
```
...
**Ejemplo con curl:**
```bash
curl "https://wpmoneyhub.preview.emergentagent.com/api/agent/memory/admin_wordpress?limit=5"
```
...
**URL Completa:**
```
https://wpmoneyhub.preview.emergentagent.com/api/agent/search-memory
```
