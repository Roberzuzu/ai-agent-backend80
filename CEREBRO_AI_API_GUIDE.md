...
## 📍 URL BASE
```
https://backend-connect-21.preview.emergentagent.com
```
...
**URL Completa:**
```
https://backend-connect-21.preview.emergentagent.com/api/agent/chat
```
...
**Ejemplo con curl:**
```bash
curl -X POST https://backend-connect-21.preview.emergentagent.com/api/agent/chat \
  -H "Content-Type: application/json" \
  -d '{
...
**URL Completa:**
```
https://backend-connect-21.preview.emergentagent.com/api/agent/memory/{user_id}?limit=10
```
...
**Ejemplo con curl:**
```bash
curl "https://backend-connect-21.preview.emergentagent.com/api/agent/memory/admin_wordpress?limit=5"
```
...
**URL Completa:**
```
https://backend-connect-21.preview.emergentagent.com/api/agent/search-memory
```
